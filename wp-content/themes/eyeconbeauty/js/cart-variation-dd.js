const dd = document.querySelector('.product-wrapper__dropdown');
const cartTable = document.querySelector('.product-wrapper__table');
const currentValue = document.querySelector('.wpcvs-selected');
