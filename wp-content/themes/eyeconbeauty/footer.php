      ...
      <div class="footer-info">
        <div class="footer-newsletter">
          ...
          <p class='newsletter-disclaimer'>
            * By signing to our newsletter you are agreeing to receive varying number of marketing emails, and by extend you are agreeing to our <a href="<?php echo home_url ( '/terms-conditions/' );?>">Terms & Conditions</a>  and <a href="<?php echo home_url ( '/privacy-policy/' );?>">Privacy Policy</a> .
          </p>
        </div>
