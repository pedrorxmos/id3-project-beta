...
<div class="woocommerce-order thankyou-wrapper">
	...
	if ( $order ) :
		...
		<?php else : ?>
			...
			<div class="thankyou-text">
				<p class="thankyou__title woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you for your order.', 'woocommerce' ), $order ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
				<p class="thankyou_confirmation">
					<?php _e( 'An email confirmation has been sent to your email.', 'woocommerce' ) ?>
				</p>
			</div>	
